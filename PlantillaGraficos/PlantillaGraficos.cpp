...
void checarColisiones() {
	...
	if (posXTriangulo+0.15f >= posXCuadrado-0.15f && 
		//Orilla superior triagulo mayot que la orilla inferior del cuadrado
		posYTriangulo+0.15f >= posYCuadrado-0.15f &&
		//orilla izquierda del triangulo sea menor que la orilla derecha del cuadrado
		posXTriangulo - 0.15f <= posXCuadrado + 0.15f && 
		//Orilla inferior triangulo menor que orilla superior del cuadrado
		posYTriangulo - 0.15f <= posYCuadrado + 0.15f) {
		rojoTriangulo = 0.0f;
		verdeTriangulo = 0.0f;
		azulTriangulo = 0.0f;
